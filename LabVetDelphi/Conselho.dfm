object FrmConselho: TFrmConselho
  Left = 224
  Top = 174
  Width = 604
  Height = 327
  Caption = 'Cadastro do Conselho Profissional'
  Color = clBtnFace
  Constraints.MaxHeight = 327
  Constraints.MaxWidth = 604
  ...
  object QryQualquer: TQuery
    ...
    object QryQualquerNomeConselho: TStringField
  ...
  object UDPQualquer: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'where'
      '  AbrevConselho = :OLD_AbrevConselho')
    InsertSQL.Strings = (
      'insert into Conselho'
      '  (AbrevConselho, NomeConselho)'
      'values'
      '  (:AbrevConselho, :NomeConselho)')
    DeleteSQL.Strings = (
