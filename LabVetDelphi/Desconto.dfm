object FrmDesconto: TFrmDesconto
  ...
  object QryQualquer: TQuery
    ...
    object QryQualquerCODDESCONTO: TAutoIncField
    ...
    object QryQualquerValorInicial: TFloatField
      FieldName = 'ValorInicial'
      Origin = 'DNLABVET.Desconto.ValorInicial'
    end
    object QryQualquerValorFinal: TFloatField
      FieldName = 'ValorFinal'
      Origin = 'DNLABVET.Desconto.ValorFinal'
    end
    object QryQualquerDesconto: TFloatField
      FieldName = 'Desconto'
  ...
  object UDPQualquer: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  Ativo = :Ativo'
      'where'
      '  CODDESCONTO = :OLD_CODDESCONTO')
    InsertSQL.Strings = (
      'insert into Desconto'
      '  (Nome, ValorInicial, ValorFinal, Desconto, Ativo)'
      'values'
      '  (:Nome, :ValorInicial, :ValorFinal, :Desconto, :Ativo)')
    DeleteSQL.Strings = (
