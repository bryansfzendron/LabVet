object FrmEspecie: TFrmEspecie
  ...
  Width = 649
  Height = 325
  Caption = 'Cadastro de Esp'#233'cie'
  Color = clBtnFace
  ...
  object QryQualquer: TQuery
    ...
    object QryQualquerCodEspecie: TAutoIncField
