    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Gerencie os tipos de exames disponíveis</p>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">A funcionalidade de exames será implementada em breve.</p>
        </div>
      </div>
    </div>
  );
